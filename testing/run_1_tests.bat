...
python "%root%\Feed_Testing\run_2\1\Feed_Testing_2.py"
python "%root%\Normal_Testing\run_2\1\Normal_Testing_2.py"
python "%root%\Parallel_Testing\run_2\1\Parallel_Testing_2.py"

python "%root%\Feed_Testing\run_3\1\Feed_Testing_3.py"
